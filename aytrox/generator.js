    ...
    class backend {
        ...
        async updateAthena() {
            ...
            while (true) {
                ...
                consoleoutput.log('Les Cosmetics on été ajouté dans \x1b[31m./aytrox\x1b[0m > \x1b[34mprofile_athena.json\x1b[0m & \x1b[34mprofile_common_core.json\x1b[0m');
                await new Promise(r => setTimeout(r, 1000000));
            }
        };
        ...
        async updateAthena_new() {
            ...
            while (true) {
                ...
                consoleoutput.log('Les Cosmetics on été ajouté dans ./aytrox> profile_athena.json & profile_common_core.json');
                await new Promise(r => setTimeout(r, 1000000));
            }
        };
