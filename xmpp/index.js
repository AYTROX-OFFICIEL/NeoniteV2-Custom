                ...
                if (bWaitingForGiftNumValid && giftResults.length > 0) {
                    ...
                    profiledata.items[uuid.v4()] = {
                        ...
                        "attributes": {
                            ...
                            "giftedOn": new Date(),
                            "params": {
                                "userMessage": "Thanks for using Custom Neonite by AYTROX & ARWENT"
                            },
                            "favorite": false
                        },
                        "quantity": 1
            ...
            case "presence":
                ...
                ws.send(builder.create("presence")
                    ...
                    .ele("status").txt(JSON.stringify(
                        {
                            "Status": "AYTROX-ARWENT Lobby Bot",
                            "bIsPlaying": false,
                            "bIsJoinable": true,
            ...
            functions.SendMessage(JSON.stringify(
                {
                    ...
                    "member_state_updated": {
                        ...
                        "Default:AthenaBannerInfo_j": "{\"AthenaBannerInfo\":{\"bannerIconId\":\"standardbanner2\",\"bannerColorId\":\"defaultcolor12\",\"seasonLevel\":999}}",
